...
// ── Auto-tag videos uploaded to Research topic ──
bot.on('message', async (msg) => {
...
bot.onText(/\/ping/, (msg) => {
  ...
  bot.sendMessage(chatId,
    `🟢 *Bot is online!*\n\nRealtime listener: ${realtimeStatus}\n\n${isRealtimeConnected ? 'Safe to toggle videos ✅' : '⚠️ Wait a moment — realtime is reconnecting. Try /ping again in 10 seconds.'}`,
